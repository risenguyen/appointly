...
public class UpdateTreatmentValidator : AbstractValidator<UpdateTreatmentRequest>
{
    public UpdateTreatmentValidator()
    {
        RuleFor(x => x.Name)
            ...
            .MaximumLength(32)
            .WithMessage("Treatment name cannot exceed 32 characters.");

        RuleFor(x => x.Description)
            .NotEmpty()
            .WithMessage("Treatment description is required.")
            .MaximumLength(100)
            .WithMessage("Treatment description cannot exceed 100 characters.");
